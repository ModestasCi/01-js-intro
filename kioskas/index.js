...
// const onlineKioskas = new Shop({ galima naudoti alternatyva, bet tada contructor({ name, currency}) turi but
//     name: 'Meskiuko kioskas',
//     currency: 'EUR'
// });
...
onlineKioskas.items();
// console.log(onlineKioskas.products);
